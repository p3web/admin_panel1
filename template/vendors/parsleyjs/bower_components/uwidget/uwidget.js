!(function ($) {
  ...
  UWidget.prototype = {
    ...
    _initActions: function () {
      var i, checked;
      this.$actions = $('<span entity="uwidget-actions"></span>');
      ...
      if (this.options.filters.enabled) {
        this.$filters = $('<span entity="filters"></span>')
          .on('change', false, $.proxy(this._updateActions, this));
      ...
      this.$container = $('<ul entity="uwidget-container"></ul>');
      this.$info = $('<span entity="uwidget-info"><a href="#" target="_blank">UWidget</a></span>');
