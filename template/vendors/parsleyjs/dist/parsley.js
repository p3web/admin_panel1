...
(function (global, factory) {
  ...
  var ParsleyDefaults = {
    ...
    errorsWrapper: '<ul entity="parsley-errors-list"></ul>',
  ...
  var typeRegexes = {
    ...
    // (first & last IP address of each entity)
  ...
  ParsleyForm.prototype = {
    ...
    _submit: function _submit($submitSource) {
      ...
      if ($submitSource) {
        ...
        if (0 === $synthetic.length) $synthetic = $('<input entity="parsley-synthetic-submit-button" type="hidden">').appendTo(this.$element);
        $synthetic.attr({
