...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    // superCall should have entity info, which can not be fetch from 'this'.
	    // Consider this case:
	    // entity A has method f,
	    // entity B inherits entity A, overrides method f, f call superApply('f'),
	    // entity C inherits entity B, do not overrides method f,
	    // then when method of entity C is called, dead loop occured.
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    module.exports = {
	        ...
	        /**
	         * Create a Path entity from path string data
	         * @param  {string} str
	         * @param  {Object} opts Other options
	         */
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * 可绘制的图形基类
	 * Base entity of all displayable graphic objects
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    /**
	     * Generate sub axis model entity
