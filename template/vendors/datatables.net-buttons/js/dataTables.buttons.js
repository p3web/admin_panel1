...
$.extend( Buttons.prototype, {
	...
	/**
	 * Add an active entity to the button to make to look active or get current
	 * active state.
	 * @param  {node} node Button element
	...
	_resolveExtends: function ( conf )
	{
		...
		while ( conf && conf.extend ) {
			...
			// Stash the current entity name
			var originalClassName = objArray.className;

			conf = $.extend( {}, objArray, conf );

			// The extend will have overwritten the original entity name if the
			// `conf` object also assigned a entity, but we want to concatenate
...
DataTable.Api.register( 'buttons.info()', function ( title, message, time ) {
	...
	$('<div id="datatables_buttons_info" entity="dt-button-info"/>')
		.html( title )
