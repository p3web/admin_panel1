...
module.exports = function(Chart) {
	...
	defaults.doughnut = {
		...
		legendCallback: function(chart) {
			var text = [];
			text.push('<ul entity="' + chart.id + '-legend">');
...
module.exports = function(Chart) {
	...
	// Base entity for all dataset controllers (line, bar, etc)
...
module.exports = function() {
	...
	//Occupy the global variable of Chart, and create a simple base entity
