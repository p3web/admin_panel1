...
var Scroller = function ( dt, opts ) {
	...
	/**
	 * DOM elements used by the entity instance
	 * @private
	 * @namespace
	 *
	 */
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	"_fnConstruct": function ()
	{
		...
		// Add entity to 'announce' that we are a Scroller table
		$(this.s.dt.nTableWrapper).addClass('DTS');

		// Add a 'loading' indicator
		if ( this.s.loadingIndicator )
		{
			this.dom.loader = $('<div entity="dataTables_processing DTS_Loading">'+this.s.dt.oLanguage.sLoadingRecords+'</div>')
				.css('display', 'none');
	...
	"_fnCalcRowHeight": function ()
	{
		...
		var container = $(
			'<div entity="'+dt.oClasses.sWrapper+' DTS">'+
				'<div entity="'+dt.oClasses.sScrollWrapper+'">'+
					'<div entity="'+dt.oClasses.sScrollBody+'"></div>'+
				'</div>'+
			'</div>'
		);
